...
class Web extends CI_Controller
{
    ...
    public function login()
    {
        ...
        if (isset($ceks)) {
            ...
            $data['icon'] = $this->Mcrud->get_setting_by_key('icon');
            $data['application_name'] = $this->Mcrud->get_setting_by_key('application_name');
            ...
            if (isset($_POST['btnlogin'])) {
                ...
                if ($jumlah == 0) {
                    ...
                    if ($cekpass <> $pass) {
                        ...
                        $this->session->set_userdata('user@mt', "$cekun");
                        $this->session->set_userdata('id_user@mt', "$row->id_user");
    ...
    {
        if ($this->session->has_userdata('user@mt') and $this->session->has_userdata('id_user@mt')) {           // Mendapatkan username pengguna yang sedang logout
            $username = $this->session->userdata('user@mt');
