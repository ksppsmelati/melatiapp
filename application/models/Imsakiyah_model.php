<?php
class Imsakiyah_model extends CI_Model
{
    private $tbl_imsakiyah = 'tbl_imsakiyah';

    public function get_data_imsakiyah()
    {
        return $this->db->get($this->tbl_imsakiyah)->result();
    }

    public function get_today_imsakiyah()
    {
        $today = date('Y-m-d');

        $this->db->where('tanggal', $today);
        return $this->db->get('tbl_imsakiyah')->row();
    }
