...
<style type="text/css">
    ...
    /* Define the border colors for each status */
    .border-success {
        border-color: #4caf50;
    }
                ...
                <div class="panel-body">
                    <div class="navigation-buttons">
                        <div class="btn-group" style="float: left;">
                            ...
                            <i class="fa fa-id-card"></i> Info Karyawan
                        </div>
                    ...
                    <hr>
                    <form action="<?= base_url('users/info_karyawan'); ?>" method="get" style="float: right;">
                                ...
                                <?php foreach ($absensi as $absen) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            // Fetch user data
                                            $foto = $this->db->get_where('tbl_user', ['id_user' => $absen['id_user']])->row();

                                            // Thumbnail path
                                            $thumbnailURL = (!empty($foto->foto_profile) && file_exists('./foto/foto_profile/' . $foto->foto_profile)) ? './foto/foto_profile/' . $foto->foto_profile : 'foto/default.png';
                                            ...
                                            switch ($absen['keterangan']) {
                                                ...
                                                case 'Cuti':
                                                    ...
                                                    break;
                                                case 'Perjalanan_tugas':
                                                    $borderClass = 'border-info';
                                                    break;
                                                default:
                                                    $borderClass = ''; // No specific color
                                                    break;
                                            }
                                            ?>
                                            <!-- Display the profile picture with dynamic border color -->
                                            <a href="<?= base_url('users/profile/profile_data/' . $absen['id_user']); ?>">
                                                <img src="<?= $thumbnailURL; ?>" alt="Thumbnail" class="circular-image <?= $borderClass; ?>" loading="lazy">
                                            </a>
                                        </td>
                                        <td style="position: sticky; left: 0; z-index: 1; background:#fff; <?= ($absen['jns_absen'] == 1) ? 'color:purple;' : ''; ?>"><?= strtoupper($absen['nama_lengkap']); ?></td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <?php
                                            $foto_absen = (!empty($absen['foto_absen']) && file_exists('./foto/foto_absen/absensi/' . $absen['foto_absen'])) ? './foto/foto_absen/absensi/' . $absen['foto_absen'] : 'foto/no_image.png';
                                            ?>
                                            <a href="javascript:void(0);" onclick="openPopup('<?php echo $foto_absen; ?>');">
                                                <img src="<?php echo $foto_absen; ?>" alt="Foto Absen" class="absensi-image" loading="lazy">
                                            </a>
                                        </td>
                                        <td><?= $absen['waktu']; ?></td>
                                        <td>
                                        ...
                                        <td><?php echo $levelText = getLevelText($absen['level']); ?> <?php echo $kodeKantorText = getKodeKantorText($absen['kode_kantor']); ?></td>
                                        <td>
                                            <?php
                                            // Mendapatkan id_user
