                ...
                <div class="panel-body">
                    ...
                    <div class="navigation-buttons">
                        <div class="btn-group" style="float: left;">
                            ...
                            <i class="fa fa-history"></i> Rekap Absensi
                        </div>
                    ...
                    <form action="<?= base_url('users/rekap_by_date_range') ?>" method="get">
                        <div class="row">
                            <div class="col-xs-5">
                    ...
                    <div class="row">
                        <div class="col-xs-3">
                            <a href="<?= base_url('users/export_rekap_by_date_range?tanggal_awal=' . $tanggal_awal . '&tanggal_akhir=' . $tanggal_akhir) ?>" class="btn btn-danger btn-sm">
        ...
        <div class="row">
            <div class="panel panel-flat">
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-xs-3">
                            <a href="<?= base_url('users/export_detail_absensi?tanggal_awal=' . $tanggal_awal . '&tanggal_akhir=' . $tanggal_akhir) ?>" class="btn btn-danger btn-sm">
                                <i class="fa fa-file-excel"></i> Export
                            </a>
                        </div>
                        <div class="col-xs-9">
                                    ...
                                    <?php foreach ($userData['absensi_detail'] as $tgl => $absensi) : ?>
                                        <td>
                                            ...
                                            if ($absensi['keterangan'] == 'Izin') {
                                                ...
                                                echo "<span style='color: purple;'>Sakit</span>";
                                            } elseif ($absensi['keterangan'] == 'Perjalanan_tugas') {
                                                echo "<span style='color: blue;'>Perjalanan Tugas</span>";
                                            } else {
