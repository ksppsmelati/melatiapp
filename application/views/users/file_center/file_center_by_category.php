        ...
        <div class="row">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <a href="<?php echo site_url('users/file_center_categories'); ?>" class="btn btn-light " style="background-color: #F2F3F5;"><i class="fa fa-arrow-left"></i></a>
                </div>
                            ...
                            <?php foreach ($files as $file) : ?>
                                <tr>
                                    ...
                                    <td style="word-wrap: break-word; white-space: normal; max-width: 100%;">
                                        <a href="<?php echo site_url('users/file_center_lihat/' . $file['id']); ?>" style="display: inline-block; max-width: 100%; overflow-wrap: break-word;">
