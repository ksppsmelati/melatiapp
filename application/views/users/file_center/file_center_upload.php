        ...
        <div class="row">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="navigation-buttons">
                        ...
                        <div class="btn-group" style="float: right;">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                <!-- <li><a href="<?php echo site_url('users/file_center_upload'); ?>"><i class="fa fa-upload"></i> Upload</a></li> -->
                    ...
                    <form id="myForm" action="<?php echo site_url('users/file_center_submit'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-xs-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select class="form-control" name="category" id="category" required onchange="toggleNewCategoryInput()">
                                        <option value="">Pilih Kategori</option>
                                        <?php foreach ($categories as $category) : ?>
                                            <option value="<?php echo htmlspecialchars($category['category']); ?>"><?php echo htmlspecialchars($category['category']); ?></option>
                                        <?php endforeach; ?>
                                        <option value="new">Input Kategori Baru</option> <!-- Option to add a new category -->
                                    </select>
                                    <input type="text" class="form-control mt-2" name="new_category" id="new_category" placeholder="Masukkan kategori baru" oninput="checkNewCategory()" style="display: none;" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="tahun" id="tahun" placeholder="Masukkan tahun" required>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" id="description" placeholder="Masukkan deskripsi file" required rows="4"></textarea>
                            </div>
                        </div>
    ...
    document.getElementById("myForm").addEventListener("submit", function(event) {
        ...
        xhr.addEventListener("load", function() {
            if (xhr.status === 200) {
                ...
                const redirectUrl = "<?php echo site_url('users/file_center_by_category'); ?>/" + encodeURIComponent(selectedCategory);
