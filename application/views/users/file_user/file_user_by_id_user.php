                ...
                <div class="panel-body">
                    <div class="navigation-buttons">
                        <div class="btn-group" style="float: left;">
                            ...
                            <i class="fa-solid fa-laptop-file"></i> My File
                        </div>
                    </div>
                    <br><br>
                    <div class="clearfix"></div>
                    <a href="users/file_user_upload" class="btn btn-danger mb-3"><i class="fa fa-upload"></i> Upload</a>
                </div>
        ...
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "<?php echo site_url('users/file_user_hapus_by_id_user/'); ?>" + fileId;
                }
            });
        });
    });
