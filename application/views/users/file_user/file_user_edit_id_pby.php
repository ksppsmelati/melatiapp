    ...
    <div class="row">
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <br>
          <legend class="text-bold"><i class="fa fa-file"></i> Edit File SLIK</legend>

          <!-- Form untuk mengedit file -->
          <form action="<?php echo site_url('users/file_user_update_id_pby/' . $file_user['id_pby']); ?>" method="post">
          <input type="hidden" class="form-control" name="id_pby" id="id_pby" value="<?php echo htmlspecialchars($file_user['id_pby']); ?>" required readonly>
            <div class="col-xs-6 col-sm-6">
              <div class="form-group">
                <label for="id_pby_view">ID:</label>
                <input type="text" class="form-control" name="id_pby_view" id="id_pby_view" value="<?php echo htmlspecialchars( 'PBY' . $file_user['id_pby']); ?>" required readonly>
              </div>
            </div>
            <div class="col-xs-6 col-sm-6">
              <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="description" id="description" value="<?php echo htmlspecialchars($file_user['description']); ?>">
              </div>
            </div>
