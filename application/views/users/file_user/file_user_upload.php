        ...
        <div class="row">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form id="myForm" action="<?php echo site_url('users/file_user_submit'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-xs-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan nama file" required>
                            </div>
                        </div>
    ...
    document.getElementById("myForm").addEventListener("submit", function(event) {
        ...
        xhr.addEventListener("load", function() {
            if (xhr.status === 200) {
                ...
                const redirectUrl = "<?php echo site_url('users/file_user_by_id'); ?>/" + encodeURIComponent(selectedCategory);
