...
$petugas_counts = [];
if (is_array($analisa_data)) {
    foreach ($analisa_data as $data) {
        $petugas_counts[$data['analyst']] = [
                ...
                <div class="panel-body">
                    <div class="navigation-buttons">
                        <div class="btn-group" style="float: left;">
                            <i class="fa fa-file-text"></i> Grafik Jumlah Analisa Petugas
                        </div>
                    ...
                    <form method="get" action="<?php echo site_url('users/infografis_analisa_petugas'); ?>">
                        <div class="row">
                            <div class="col-xs-4">
                            ...
                            <div class="col-xs-2">
                                <a href="<?php echo site_url('users/infografis_analisa_petugas'); ?>" class="btn btn-secondary"><i class="fa fa-refresh"></i></a>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    tooltip: {
                        callbacks: {
                            label: function(tooltipItem) {
                                return tooltipItem.raw + ' Analisa';
                            }
                        }
                    }
                }
