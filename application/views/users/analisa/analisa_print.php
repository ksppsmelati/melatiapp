...
<head>
    ...
    <title><?php echo $survey->nama; ?></title>
    ...
    <div class="container">
        ...
        <table class="info-table">
            <tr>
                ...
                <td class="value"><span>:</span>
                    <?php
                    if (!empty($survey->tgl_cek_bi)) {
                        echo date('Ymd', strtotime($survey->tgl_cek_bi)) . '_PBY' . $survey->id;
                    } else {
                        echo 'PBY' . $survey->id;
                    }
                    ?>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table">
                    ...
                    <tr>
                        <th>Alamat</th>
                        <td><span>: </span><?php echo $survey->alamat; ?> <?php echo $survey->kelurahan_nama; ?> <?php echo $survey->kecamatan_nama; ?></td>
                    </tr>
                    <tr>
                        <th>No. Telp</th>
        ...
        <div class="footer">
            <p style="text-align: right; margin-right: 0px;">
                <?php
                $kota = isset($survey->kota_nama) ? $survey->kota_nama : '';
                ...
                if (isset($survey->tgl_cek_bi)) {
                    $tanggal = strtotime($survey->tgl_cek_bi);
                    $hari = date('d', $tanggal);
            ...
            <div class="signature" style="position: absolute; right: 0; z-index: 10; text-align: center;">
                <?php
                $ttd = isset($survey->ttd) ? $survey->ttd : '';
