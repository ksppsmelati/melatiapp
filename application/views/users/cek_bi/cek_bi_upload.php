                ...
                <div class="panel-body">
                    <div class="navigation-buttons">
                        <div class="btn-group" style="float: left;">
                            <i class="fa fa-upload"></i> Upload SLIK - <strong><?php echo 'MLT' . $row_id; ?></strong> | <span style="font-size: 80%; opacity: 0.7;"> <?= $cek_bi_data->nama ?></span>
                        </div>
                    ...
                    <form id="myForm" action="<?php echo site_url('users/cek_bi_submit_slik'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" class="form-control" name="id_mlt" id="id_mlt" value="<?php echo $row_id; ?>" required readonly>
                        <input type="hidden" class="form-control" name="nama" id="nama" value="<?= $cek_bi_data->nama ?>" required readonly>
                        <div class="col-xs-6 col-sm-6" style="display: none;">
                            <div class="form-group">
                                <label for="category">Kategori:</label>
                                <input type="text" class="form-control" name="category" id="category" value="SLIK_MLT" readonly>
                            </div>
                        </div>
