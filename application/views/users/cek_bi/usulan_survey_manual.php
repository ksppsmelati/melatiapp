            ...
            <div class="panel panel-flat">
                <div class="panel-body">
                    <div class="navigation-buttons">
                        <i class="fa fa-poll"></i> Form Survey Manual
                    ...
                    <hr>
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" action="<?= base_url('users/update_survey_manual/' . $survey_data->usulan_id); ?>">
                                ...
                                <div class="col-xs-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="capai_lokasi" id="capai_lokasi" class="form-control">
                                            ...
                                            <option value="jalan_kali">Jalan Kaki</option>
