                    ...
                    <fieldset class="content-group">
                        <div class="navigation-buttons">
                            <div class="btn-group" style="float: left;">
                                <i class="fa fa-television"></i> Tambah SP Manual
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="nokontrak" id="nokontrak" class="form-control" value="" required >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="noakad" id="noakad" class="form-control" value="" required >
                                        </div>
                                    </div>
                                </div>
                                <!-- Tanggal -->
                                <div class="col-md-6" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="date" name="tgl_input" id="tgl_input" class="form-control" value="" required >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="kdloc" id="kdloc" class="form-control" value="" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="date" name="tglakad" id="tglakad" class="form-control" value="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="jnsdokumen" id="jnsdokumen" class="form-control" value="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="file" name="foto_sp" id="foto_sp" class="form-control" accept="image/*" onchange="previewImage(event, 'preview1')">
