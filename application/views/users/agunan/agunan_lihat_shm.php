                    ...
                    <fieldset class="content-group">
                        <div class="navigation-buttons">
                            ...
                            <div class="btn-group" style="float: right;">
                                <a href="<?php echo site_url('users/agunan_cetak_shm/' . $agunan->id); ?>" class="btn btn-danger" target="_blank">
                                ...
                                if (in_array($user->row()->level, $allowedLevels)) {
                                    echo '<a href="' . site_url('users/agunan/agunan_edit_shm/' . $agunan->id) . '" class="btn btn-primary">
...
<script>
    ...
    document.getElementById('shareButton').addEventListener('click', function() {
        ...
        var url = '<?php echo site_url('users/agunan_lihat_shm/' . $agunan->id); ?>';
        ...
        $('#shareButton').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    window.location.href = '<?= base_url("users/agunan_shm") ?>';
                },
