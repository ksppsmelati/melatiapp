                ...
                <div class="panel-body">
                    <div class="navigation-buttons">
                        <div class="btn-group" style="float: left;">
                            <i class="fa fa-id-card"></i> DATA BPKB
                        </div>
                        ...
                        <div class="btn-group" style="float: right;">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                <li><a href="<?php echo site_url('users/agunan'); ?>"><i class="fa fa-id-card"></i> DATA BPKB</a></li>
                                <li><a href="<?php echo site_url('users/agunan_shm'); ?>"><i class="fa fa-folder"></i> DATA SHM</a></li>
                                <?php
                    ...
                    <div class="col-md-6 mb-3 mb-md-0" style="margin-bottom: 10px;">
                        ...
                        if (in_array($user->row()->level, $allowedLevels)) {
                            echo '<a href="users/agunan_tambah" class="btn btn-danger">+ Tambah BPKB</a>';
                        }
                        ?>
                        <?php
                        $allowedLevels = ['admin', 'k_arsip', 'kadiv_opr', 's_admin'];
                        ...
                        if (in_array($user->row()->level, $allowedLevels)) {
                            echo '<a href="users/agunan_tambah_shm" class="btn btn-primary">+ Tambah SHM</a>';
                        }
                        ?>
                    </div>
                    <form method="get" action="<?= site_url('users/agunan'); ?>" style="float: right;">
                        <div class="row">
                                ...
                                <?php foreach ($agunan_data as $data) : ?>
                                    <tr>
                                        ...
                                        <td style="position: sticky; left: 0; z-index: 1; background:#fff;">
                                            <a href="<?php echo site_url('users/agunan_lihat/' . $data->id); ?>">
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('users/agunan_lihat/' . $data->id); ?>" class="btn btn-primary btn-xs"><i class="icon-eye"></i></a>
                                            <?php
                                            $allowedLevels = ['kadiv_opr', 'admin', 'k_arsip', 's_admin','k_admin'];
                                            if (in_array($user->row()->level, $allowedLevels)) : ?>
                                                <a href="<?php echo site_url('users/agunan_edit/' . $data->id); ?>" class="btn btn-success btn-xs"><i class="icon-pencil7"></i></a>
                                            <?php endif; ?>
                                            <?php
        ...
        $('.delete-agunan').on('click', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = '<?php echo site_url('users/agunan_delete/'); ?>' + shmId;
                }
            });
        });
    });

    // Menggunakan class sebagai pemilih dan event delegation
    $(document).ready(function() {
        ...
        $(document).on('click', '#shareButton', function() {
            ...
            // Membentuk URL
            var url = '<?php echo site_url("users/agunan_lihat/"); ?>' + agunanId;
