                    ...
                    <fieldset class="content-group">
                        <div class="navigation-buttons">
                            <div class="btn-group" style="float: left;">
                                <i class="icon-pencil7"></i> EDIT DATA SHM - ID: <?php echo $agunan->id; ?><br>
                        ...
                        <form class="form-horizontal" id="myForm" action="<?php echo site_url('users/agunan_update_shm/' . $id_agunan); ?>" enctype="multipart/form-data" method="post">
                            <div class="row">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <select class="form-control" name="status" id="status" required onchange="toggleFields()" <?= $isDisabled; ?>>
                                                ...
                                                <?php if ($level === 's_admin' || $level === 'k_arsip'|| $level === 'k_admin') : ?>
                                                    ...
                                                    <option value="NOTARIS" <?php if ($agunan->status == "NOTARIS") echo "selected"; ?>>NOTARIS</option>
                                                <?php endif; ?>
                                                <?php if ($level === 'admin') : ?>
                                ...
                                <div class="clearfix"></div>
                                <hr>
                                <a href="users/agunan_shm" class="btn btn-default">
                                    << Kembali</a>
...
<script>
    ...
    Dropzone.options.myDropzone = {
        url: "<?php echo site_url('users/agunan_update_shm/' . $id_agunan); ?>",
