            ...
            <div class="panel panel-flat">
                <div class="panel-body">
                    <div class="navigation-buttons">
                        <i class="fa fa-poll"></i> Form Edit Survey <br>
                        <span style="font-size: 80%; opacity: 0.7;"><?php echo date('d-m-Y', strtotime($survey_data->tanggal)); ?></span>
                        <span style="font-size: 80%; opacity: 0.7;"> | <?php echo $this->Usulan_model->getUsernameById($survey_data->id_user); ?></span>
                        <span style="font-size: 80%; opacity: 0.7;"> / <?php echo date('d-m-Y', strtotime($survey_data->tgl_survey)); ?></span>
                        <span style="font-size: 80%; opacity: 0.7;"> | <?php echo $this->Usulan_model->getUsernameById($survey_data->surveyor); ?></span>
                        ...
                        <form method="post" enctype="multipart/form-data" action="<?= base_url('users/update_survey/' . $survey_data->usulan_id); ?>">
                            ...
                            <div class="col-xs-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="sumber_pelunasan" id="sumber_pelunasan" class="form-control" required>
                                        <!-- Pastikan nilai sumber_pelunasan terisi saat form di-render -->
                                        <option value="gaji" <?= isset($survey_data->sumber_pelunasan) && $survey_data->sumber_pelunasan == 'gaji' ? 'selected' : ''; ?>>Gaji</option>
                                        <option value="hasil_usaha" <?= isset($survey_data->sumber_pelunasan) && $survey_data->sumber_pelunasan == 'hasil_usaha' ? 'selected' : ''; ?>>Hasil Usaha</option>
                                        <option value="lainya" <?= isset($survey_data->sumber_pelunasan) && $survey_data->sumber_pelunasan == 'lainya' ? 'selected' : ''; ?>>Lainnya</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6">
                            ...
                            <div class="col-xs-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="tempat_survey" id="tempat_survey" class="form-control" required>
                                        <option value="rumah" <?= isset($survey_data->tempat_survey) && $survey_data->tempat_survey == 'rumah' ? 'selected' : ''; ?>>Rumah</option>
                                        <option value="kantor" <?= isset($survey_data->tempat_survey) && $survey_data->tempat_survey == 'kantor' ? 'selected' : ''; ?>>Kantor</option>
                                        <option value="tempat_usaha" <?= isset($survey_data->tempat_survey) && $survey_data->tempat_survey == 'tempat_usaha' ? 'selected' : ''; ?>>Tempat Usaha</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="kondisi_rumah" id="kondisi_rumah" class="form-control" required>
                                        ...
                                        <option value="permanen" <?= isset($survey_data->kondisi_rumah) && $survey_data->kondisi_rumah == 'permanen' ? 'selected' : ''; ?>>Permanen</option>
                                        <option value="semi_permanen" <?= isset($survey_data->kondisi_rumah) && $survey_data->kondisi_rumah == 'semi_permanen' ? 'selected' : ''; ?>>Semi Permanen</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-xs-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="capai_lokasi" id="capai_lokasi" class="form-control">
                                            <option value="jalan_kaki" <?php echo ($survey_data->capai_lokasi == 'jalan_kaki') ? 'selected' : ''; ?>>Jalan Kaki</option>
                                            <option value="roda_dua" <?php echo ($survey_data->capai_lokasi == 'roda_dua') ? 'selected' : ''; ?>>Roda Dua</option>
                                            <option value="roda_empat" <?php echo ($survey_data->capai_lokasi == 'roda_empat') ? 'selected' : ''; ?>>Roda Empat</option>
                                            <option value="roda_diatas_empat" <?php echo ($survey_data->capai_lokasi == 'roda_diatas_empat') ? 'selected' : ''; ?>>Roda diatas empat</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="bentuk_tanah" id="bentuk_tanah" class="form-control">
                                            <option value="segiempat" <?php echo ($survey_data->bentuk_tanah == 'segiempat') ? 'selected' : ''; ?>>Segiempat</option>
                                            <option value="segitiga" <?php echo ($survey_data->bentuk_tanah == 'segitiga') ? 'selected' : ''; ?>>Segitiga</option>
                                            <option value="trapesium" <?php echo ($survey_data->bentuk_tanah == 'trapesium') ? 'selected' : ''; ?>>Trapesium</option>
                                            <option value="tak_beraturan" <?php echo ($survey_data->bentuk_tanah == 'tak_beraturan') ? 'selected' : ''; ?>>Tak beraturan</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="jenis_tanah" id="jenis_tanah" class="form-control">
                                            <option value="pekarangan" <?php echo ($survey_data->jenis_tanah == 'pekarangan') ? 'selected' : ''; ?>>Pekarangan</option>
                                            <option value="pertanian" <?php echo ($survey_data->jenis_tanah == 'pertanian') ? 'selected' : ''; ?>>Pertanian</option>
                                            <option value="sawah" <?php echo ($survey_data->jenis_tanah == 'sawah') ? 'selected' : ''; ?>>Sawah</option>
                                            <option value="lainnya" <?php echo ($survey_data->jenis_tanah == 'lainnya') ? 'selected' : ''; ?>>Lainnya</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="akses_jalan" id="akses_jalan" class="form-control">
                                            <option value="aspal" <?php echo ($survey_data->akses_jalan == 'aspal') ? 'selected' : ''; ?>>Aspal</option>
                                            <option value="semen" <?php echo ($survey_data->akses_jalan == 'semen') ? 'selected' : ''; ?>>Semen</option>
                                            <option value="tanah" <?php echo ($survey_data->akses_jalan == 'tanah') ? 'selected' : ''; ?>>Tanah</option>
                                            <option value="lainnya" <?php echo ($survey_data->akses_jalan == 'lainnya') ? 'selected' : ''; ?>>Lainnya</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-6">
                                ...
                                <div class="col-xs-6 col-sm-6">
                                    <div class="form-group file-upload-group">
                                        ...
                                        ?>
                                            <div class="mt-2">
                                                <a href="javascript:void(0);" onclick="openPopup('<?php echo $thumbnailURL; ?>');">
                                                    <img src="<?php echo $thumbnailURL; ?>" alt="Thumbnail Foto Jaminan 1" class="img-preview" />
                                                </a>
                                            </div>
                                        <?php
                                        } else {
                                        ...
                                        ?>
                                        <input type="file" name="foto_jaminan_1" id="foto_jaminan_1" class="form-control" accept="image/*" onchange="previewImage(event, 'preview1')">
                                ...
                                <div class="col-xs-6 col-sm-6">
                                    <div class="form-group file-upload-group">
                                        ...
                                        ?>
                                            <div class="mt-2">
                                                <a href="javascript:void(0);" onclick="openPopup('<?php echo $thumbnailURL; ?>');">
                                                    <img src="<?php echo $thumbnailURL; ?>" alt="Thumbnail Foto Jaminan 2" class="img-preview" />
                                                </a>
                                            </div>
                                        <?php
                                        } else {
                                        ...
                                        ?>
                                        <input type="file" name="foto_jaminan_2" id="foto_jaminan_2" class="form-control" accept="image/*" onchange="previewImage(event, 'preview2')">
                                        <div class="preview-container">
                                ...
                                <div class="col-xs-6 col-sm-6">
                                    <div class="form-group file-upload-group">
                                        ...
                                        ?>
                                            <div class="mt-2">
                                                <a href="javascript:void(0);" onclick="openPopup('<?php echo $thumbnailURL; ?>');">
                                                    <img src="<?php echo $thumbnailURL; ?>" alt="Thumbnail Foto Jaminan 3" class="img-preview" />
                                                </a>
                                            </div>
                                        <?php
                                        } else {
                                        ...
                                        ?>
                                        <input type="file" name="foto_jaminan_3" id="foto_jaminan_3" class="form-control" accept="image/*" onchange="previewImage(event, 'preview3')">
                                        <div class="preview-container">
                                ...
                                <div class="col-xs-6 col-sm-6">
                                    <div class="form-group file-upload-group">
                                        ...
                                        ?>
                                            <div class="mt-2">
                                                <a href="javascript:void(0);" onclick="openPopup('<?php echo $thumbnailURL; ?>');">
                                                    <img src="<?php echo $thumbnailURL; ?>" alt="Thumbnail Foto Jaminan 4" class="img-preview" />
                                                </a>
                                            </div>
                                        <?php
                                        } else {
                                        ...
                                        ?>
                                        <input type="file" name="foto_jaminan_4" id="foto_jaminan_4" class="form-control" accept="image/*" onchange="previewImage(event, 'preview4')">
                                        <div class="preview-container">
                            ...
                            <form method="post" id="checklistForm">
                                ...
                                <button type="submit" class="btn btn-danger" id="kirimButton" style="float:right;" disabled> Update Survey</button>
                            </form>
                        </form>
                    </div>
                </div>
