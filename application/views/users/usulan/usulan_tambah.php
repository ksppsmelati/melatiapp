            ...
            <div class="panel panel-flat">
                <div class="panel-body">
                    <div class="navigation-buttons">
                        <i class="fa fa-file-text"></i> Tambah Usulan
                    ...
                    <hr>
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" action="<?php echo site_url('users/usulan_simpan'); ?>" id="myForm">
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6">
                                    <div class="form-group">
                                        <label for="form_nama">Nama Lengkap<span style="color: red;">*</span></label>
                                ...
                                <div class="col-xs-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="nik" id="nik" required placeholder="Nomor Induk Kependudukan" minlength="16" maxlength="16" inputmode="numeric" oninput="validateNIK(this); cekNIK(this)">
                                        <span id="nikError" style="color: red; display: none;">NIK harus berisi tepat 16 angka.</span>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-xs-6 col-sm-6">
                                    <div class="form-group">
                                        <label for="form_tujuan">Tujuan pembiayaan<span style="color: red;">*</span></label>
                                        <input class="form-control" type="text" name="tujuan" required placeholder="Tujuan pembiayaan">
                                    </div>
                                </div>

                                <div class="col-xs-6 col-sm-6">
                                    <div class="form-group">
                                        <label for="form_nominal">Plafon Usulan<span style="color: red;">*</span></label>
                                        <input class="form-control" type="text" id="formatted_nominal" required placeholder="Plafon Usulan">
                                ...
                                <div class="col-xs-6 col-sm-6">
                                    <div class="form-group">
                                        <label for="form_jw">Jangka Waktu<span style="color: red;">*</span></label>
                                        <input list="jangka_waktu_options" class="form-control" name="jangka_waktu" id="jangka_waktu" placeholder="Masukkan atau pilih jangka waktu" type="number" required>
                                        <datalist id="jangka_waktu_options">
                                            <option value="3">(tempo)</option>
                                            <option value="6">(tempo)</option>
                                            <option value="9">(tempo)</option>
                                ...
                                <div class="col-xs-6 col-sm-6">
                                    <div class="form-group">
                                        <label for="form_jaminan">Jaminan<span style="color: red;">*</span></label>
                                        <select class="form-control" name="jaminan" id="jaminan" required>
                                            <option value="" selected>Jenis jaminan</option>
                                            <option value="sertifikat">Sertifikat (SHM)</option>
                                ...
                                <div id="sertifikat-section" style="display: none;">
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sertifikat" id="sertifikat" class="form-control" placeholder="Masukan nomor sertifikat">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="tgl_pembukuan">Tanggal Pembukuan</label>
                                            <input type="date" name="tgl_pembukuan" id="tgl_pembukuan" class="form-control" value="<?php echo date('Y-m-d'); ?>" placeholder="Masukan tanggal pembukuan sertifikat">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="an_sertifikat">Atas Nama Sertifikat</label>
                                            <input type="text" name="an_sertifikat" id="an_sertifikat" class="form-control" placeholder="Masukan atas nama sertifikat">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div style="position: relative;">
                                                <input type="number" name="luas" id="luas" class="form-control" placeholder="Masukkan luas tanah" style="padding-right: 30px;">
                                    ...
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nib" id="nib" class="form-control" placeholder="Masukan NIB">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="alamat_lokasi">Kecamatan Letak tanah</label>
                                            <input type="text" name="alamat_lokasi" id="alamat_lokasi" class="form-control" placeholder="Masukan kecamatan letak tanah">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12">
                                        <div class="form-group">
                                            <label for="batas">Batas-batas</label>
                                            <textarea name="batas" id="batas" class="form-control" placeholder="Contoh: Utara: Desa A, Timur: Sungai X, Selatan: Jalan Y, Barat: Kebun Z">Utara: Timur: Selatan: Barat: </textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="bpkb-section" style="display: none;">
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bpkb" id="bpkb" class="form-control" placeholder="Masukan nomor BPKB">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="no_pol" id="no_pol" class="form-control" placeholder="Masukan nomor polisi">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="no_rangka">Nomor Rangka</label>
                                            <input type="text" name="no_rangka" id="no_rangka" class="form-control" placeholder="Masukan nomor rangka">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="no_mesin">Nomor Mesin</label>
                                            <input type="text" name="no_mesin" id="no_mesin" class="form-control" placeholder="Masukan nomor mesin">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="thn_pembuatan">Tahun Pembuatan</label>
                                            <input type="text" name="thn_pembuatan" id="thn_pembuatan" class="form-control" placeholder="Masukkan tahun pembuatan">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="warna">Warna</label>
                                            <input type="text" name="warna" id="warna" class="form-control" placeholder="Masukan warna">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="jns_kendaraan">Jenis Kendaraan</label>
                                            <input type="text" name="jns_kendaraan" id="jns_kendaraan" class="form-control" placeholder="Masukan atas jenis kendaraan">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="an_bpkb">Atas nama BPKB</label>
                                            <input type="text" name="an_bpkb" id="an_bpkb" class="form-control" placeholder="Masukan atas nama bpkb">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="alamat_bpkb" id="alamat_bpkb" class="form-control" placeholder="Masukan alamat bpkb">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="lainnya-section" style="display: none;">
                                <div class="col-xs-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lainnya" id="lainnya" class="form-control" placeholder="Masukan jenis jaminan lainnya">
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    document.getElementById('form').addEventListener('submit', function(event) {
        ...
        if (jaminan === "") {
            alert('Silakan pilih jenis jaminan!');
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#provinsi, #kota_kabupaten, #kecamatan, #kelurahan, #status_kawin, #status_pendidikan, #kode_kantor').select2({
            allowClear: false,
            placeholder: "Pilih"
        });
    ...
    function validateNIK(input) {
        ...
        // Tampilkan pesan kesalahan jika kurang dari 16 angka
        const nikError = document.getElementById('nikError');
        if (input.value.length !== 16) {
            nikError.style.display = 'block'; // Tampilkan pesan kesalahan
        } else {
            nikError.style.display = 'none'; // Sembunyikan pesan kesalahan
        }
    }
    ...
    function cekNIK(input) {
        var nik = input.value;

        if (nik.length === 16) { // Pastikan NIK memiliki 16 karakter
            $.ajax({
                url: '<?= base_url("users/cek_nik"); ?>', // URL untuk cek NIK
                type: 'POST',
                data: {
                    nik: nik
                },
                ...
                success: function(response) {
                    if (response.status === 'error') {
                        // Tampilkan popup menggunakan SweetAlert2 jika NIK sudah ada
                        Swal.fire({
                            icon: 'info',
                            title: 'Informasi',
                            ...
                            reverseButtons: true, // Mengubah posisi tombol
                        }).then((result) => {
                            if (result.isConfirmed) {
                                // Jika memilih Lanjutkan, biarkan input NIK tetap ada
                            } else if (result.isDismissed) {
                                // Jika memilih Batal, kosongkan input NIK
                                input.value = '';
                            }
                        });
                    }
    ...
    // Fungsi untuk memformat angka menjadi format Rupiah dengan pemisah ribuan
    function formatRupiah(number) {
        return number.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".");
    }

    // Fungsi untuk menghapus format sebelum menyimpan ke hidden input
    ...
    document.getElementById('formatted_nominal').addEventListener('input', function(e) {
        ...
        let rawInput = formattedInput.replace(/[^0-9]/g, '');

        // Tampilkan nilai dengan format Rupiah (ribuan dipisah titik)
        e.target.value = formatRupiah(rawInput);

        // Set nilai asli (tanpa format) ke hidden input
        document.getElementById('nominal').value = removeFormatting(e.target.value);
    });
</script>