            ...
            <div class="panel panel-flat">
                <div class="panel-body">
                    <div class="navigation-buttons">
                        <i class="fa-solid fa-file-import"></i> Usulan Masuk
                    ...
                    <table class="table datatable-basic" width="100%">
                        ...
                        <tbody>
                            ...
                            foreach ($usulan_data as $usulan) :
                                ...
                                if (!in_array($level, ['surveyor', 's_admin', 'kadiv_manrisk'])) :
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                $allowedLevels = ['s_admin', 'k_cabang', 'surveyor','kadiv_manrisk'];
                                                if (in_array($level, $allowedLevels)) :
                                                ?>
                                                    <?php
                                                    echo '<a href="' . base_url('users/usulan_survey/' . $usulan->id) . '" class="btn btn-success btn-xs"  style="margin: 1px;"><i class="fa-solid fa-person-running"></i>Survey</a>';
                                                    echo '<a href="' . base_url('users/usulan_edit/' . $usulan->id) . '" class="btn btn-primary btn-xs""  style="margin: 1px;"><i class="fa fa-pencil"></i></a>';
                                                    echo '<a href="' . base_url('users/analisa_print/' . $usulan->id) . '" class="btn btn-info btn-xs" target="_blank"  style="margin: 1px;"><i class="fa-solid fa-print"></i></a>';
                                                    // echo '<a href="' . base_url('users/file_user_lihat_id_pby/' . $usulan->id) .  '" class="btn btn-xs" style="background-color: #6f42c1; color: white;"><i class="fa-solid fa-book-open"></i></a>';
                                                    if (isset($file_user) && $file_user !== null) {
                                                        echo '<a href="' . base_url('users/file_user_lihat_id_pby/' . $usulan->id) . '" class="btn btn-xs" style="background-color: #6f42c1; color: white;"><i class="fa-solid fa-book-open"></i></a>';
                                                    }
                                                    ?>
                                                <?php endif; ?>
                                                <?php
                                                $allowedLevels_manual = ['s_admin'];
                                                if (in_array($level, $allowedLevels_manual)) :
                                                ?>
                                                    <?php
                                                    echo '<a href="' . base_url('users/usulan_survey_manual/' . $usulan->id) . '" class="btn btn-info btn-xs"  style="margin: 1px;"><i class="fa-solid fa-person-running"></i>Survey</a>';
                                                    ?>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                                <?php
                                                echo '<a href="' . base_url('users/usulan_survey/' . $usulan->id) . '" class="btn btn-success btn-xs"  style="margin: 2px;"><i class="fa-solid fa-person-running"></i>Survey</a>';
                                                echo '<a href="' . base_url('users/usulan_edit/' . $usulan->id) . '" class="btn btn-primary btn-xs""  style="margin: 2px;"><i class="fa fa-pencil"></i></a>';
                                                echo '<a href="' . base_url('users/analisa_print/' . $usulan->id) . '" class="btn btn-info btn-xs" target="_blank"  style="margin: 2px;"><i class="fa-solid fa-print"></i></a>';
                                                ?>
                                            <?php endif; ?>
                                            <?php
                                                $allowedLevels_manual = ['s_admin'];
