            ...
            <fieldset class="content-group">
              ...
              <form class="form-horizontal" action="" method="post">
                  ...
                  <div class="col-lg-9">
                    ...
                    <select class="form-control" name="bagian">
                      ...
                      foreach ($bagian as $baris) { ?>
                        <option value="<?php echo $baris->id_bagian; ?>" <?php if ($baris->id_bagian == $query->id_bagian) {
                             echo "selected";
                           } ?>><?php echo $baris->nama_bagian; ?>
                        </option>
                        <?php
                      } ?>
                    </select>
                ...
                <a href="users/sk" class="btn btn-default">
                  << Kembali</a>
                    <button type="submit" name="btnupdate" id="submit-all" class="btn btn-primary"
