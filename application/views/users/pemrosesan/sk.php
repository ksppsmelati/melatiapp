      ...
      <div class="panel panel-flat">
        <div class="panel-heading">
          <div class="navigation-buttons">
            <a href="users/sm" class="btn btn-primary">
              <i class="fa fa-sign-in"></i> Otorisasi Masuk
            </a>
            <a href="users/ss" class="btn btn-success">
              <i class="fa fa-check"></i> Otorisasi Selesai
            </a>
