...
<div class="content-wrapper">
  ...
  <div class="content">
              ...
              <form class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                <div class="form-group">
                  ...
                  <div class="col-lg-4">
                    <div class="input-group">
                      ...
                      <input type="text" name="tgl_ns" class="form-control daterange-single" id="tgl_ns"
                        value="<?php echo $query->tgl_ns; ?>" maxlength="10" required placeholder="Masukkan Tanggal">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    <input type="text" name="penerima" id="penerima" class="form-control"
                      value="<?php echo $query->nama_lengkap; ?>" placeholder="">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    <input type="text" name="nominal" id="nominal" class="form-control"
                      value="<?php echo $query->nominal; ?>" placeholder="">
                  </div>
                </div>
                <?php if ($query->disposisi != '') { ?>
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="text" name="nominal" id="nominal" class="form-control"
                        value="<?php echo $query->disposisi; ?>" placeholder="">
                    </div>
                  </div>
                <?php } ?>
                <div class="form-group">
                    ...
                    <table class="table table-bordered" width="100%">
                      ...
                      foreach ($lampiran->result() as $baris) { ?>
                        <tr>
                          ...
                          <td><a href="lampiran/<?php echo $baris->nama_berkas; ?>" target="_blank"
                              title="<?php echo substr($baris->ukuran / 1024, 0, 5); ?> MB"><?php echo $baris->nama_berkas; ?></a></td>
                          <td><a href="lampiran/<?php echo $baris->nama_berkas; ?>" target="_blank"
                ...
                <a href="users/sk" class="btn btn-default">
                  << Kembali</a>
                    <?php if ($user->row()->level == 'admin'): ?>
                      <?php if ($query->disposisi == '') { ?>
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#disposisi"
                          style="float:right;">Disposisi</button>
                      <?php } else { ?>
                        <button type="submit" name="btndisposisi0" class="btn btn-primary" style="float:right;"
                          onclick="return confirm('Anda yakin?')">Batal Disposisi</button>
                      <?php } ?>

                      <?php if ($query->peringatan == 0) { ?>
                        <button type="submit" name="btnperingatan" class="btn btn-warning"
                          style="float:right;margin-right:10px;" onclick="return confirm('Anda yakin?')">Peringatan</button>
                      <?php } else { ?>
                        <button type="submit" name="btnperingatan0" class="btn btn-warning"
                          style="float:right;margin-right:10px;" onclick="return confirm('Anda yakin?')">Batal
                          Peringatan</button>
                      <?php } ?>
                    <?php endif; ?>
              </form>
    ...
    <!-- Modal -->
    <div class="modal fade" id="disposisi" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
      aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <form class="" action="" method="post">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" name="btndisposisi" class="btn btn-primary"
                onclick="return confirm('Anda yakin?')">Kirim</button>
            </div>
          </form>
        </div>
      </div>
