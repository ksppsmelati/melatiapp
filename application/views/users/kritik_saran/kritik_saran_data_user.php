        ...
        <div class="panel-body">
          <div class="navigation-buttons">
            <div class="btn-group" style="float: left;">
              ...
              <i class="fa-solid fa-envelope-open-text"></i> Data Kritik & Saran<br>
              <?php
                    echo '<br>';
                    echo '<a href="' . site_url('users/kritik_saran_tambah') . '" class="btn btn-danger">+ Tambah</a>';
                    ?>
            </div>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="reply-status">
                        ...
                        <a href="<?php echo site_url('users/kritik_saran_lihat/' . $baris['id']); ?>" title="<?php echo htmlspecialchars(strip_tags($baris['status'])); ?>">
                    ...
                    <td>
                      ...
                      <a href="<?php echo site_url('users/kritik_saran/kritik_saran_edit_user/' . (!empty($baris['id']) ? $baris['id'] : '')); ?>" class="btn btn-success btn-xs"><i class="icon-pencil7"></i></a>
