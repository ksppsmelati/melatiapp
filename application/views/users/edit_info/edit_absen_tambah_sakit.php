                ...
                <div class="panel-body">
                    <div class="navigation-buttons">
                        <div class="btn-group" style="float: left;">
                            ...
                            <i class="fa fa-fingerprint"></i> Form Izin Sakit
                        </div>
                        ...
                        <form id="myForm" action="<?= base_url('users/simpan_absen'); ?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="keterangan" name="keterangan" value="Sakit" readonly>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="dropzone" id="myDropzone">
                                            <div class="dz-message">
                                                ...
                                                <p class="upload-text">Foto Surat Keterangan Dokter</p>
                                            </div>
                                        </div>
        ...
        init: function() {
            ...
            this.on("success", function(file, response) {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Sukses!',
                    text: 'Data Keterangan sakit berhasil dikirim.',
