                        ...
                        <form id="myForm" action="<?= base_url('users/simpan_absen'); ?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="kantorSelect">Kantor:</label>
                                        <select class="form-control" id="kantorSelect" onchange="updateLocation()">
                                            <option>Pilih Kantor</option>
                                            <option>Kantor Sedayu</option>
                                            <option>Kantor Sapuran</option>
                                            <option>Kantor Pusat</option>
                                            <option>Kantor Wonosobo</option>
                                            <option>Kantor Kertek</option>
                                            <option>Kantor Kaliwiro</option>
                                            <option>Kantor Randusari</option>
                                            <option>Kantor Banjarnegara</option>
                                            <option>Kantor Kepil</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" id="waktu" name="waktu" value="<?= date('H:i:s'); ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
...
<script>
            ...
            this.on("success", function(file, response) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location = "<?php echo base_url(); ?>users/edit_absen_tambah_sys";
                    }
                });
            });
        }
    ...
    function updateLocation() {
        const select = document.getElementById("kantorSelect");
        const latitudeInput = document.getElementById("latitude");
        const longitudeInput = document.getElementById("longitude");
        const selectedKantor = kantorLocations[select.selectedIndex];

        latitudeInput.value = selectedKantor.latitude;
        longitudeInput.value = selectedKantor.longitude;
    }
</script>