                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-4">
                        <select class="form-control" name="jenis_ns">
                          ...
                          <option value="sm" <?php if($query->jenis_ns == "sm"){echo "selected";} ?>>Otorisasi Masuk</option>
                          <option value="sk" <?php if($query->jenis_ns == "sk"){echo "selected";} ?>>Otorisasi Keluar</option>
