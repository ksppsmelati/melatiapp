        ...
        <div class="row">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <legend class="text-bold"><i class="fa fa-briefcase"></i> Rekap Laporan Kerja | Devisi : <?php echo ucwords($kode_devisi); ?> | Kantor : <?php echo ucwords($kode_kantor); ?></legend>
                    <form method="post" action="<?php echo site_url('users/laporan_kerja_by_devisi'); ?>">
                        <div class="col-xs-5">
                                ...
                                <?php foreach ($laporan_kerja as $laporan) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- <a href="<?php echo site_url('users/laporan_kerja_edit/' . $laporan['id']); ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                            <a href="<?php echo site_url('users/laporan_kerja_hapus/' . $laporan['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus laporan ini?')"><i class="fas fa-trash-alt"></i></a> -->
