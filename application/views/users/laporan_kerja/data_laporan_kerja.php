                    ...
                    <div class="navigation-buttons">
                        ...
                        <div class="btn-group" style="float: right;">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                ...
                                <li><a href="<?= base_url('users/laporan_kerja_export_word?bulan=' . $selectedMonth . '&tahun=' . $selectedYear) ?>"><i class="fa-solid fa-file-word"></i> Export to Word</a></li>
                                <li><a href="<?= base_url('users/laporan_kerja_export_excel?bulan=' . $selectedMonth . '&tahun=' . $selectedYear) ?>"><i class="fa-solid fa-file-excel"></i> Export to  Excel</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- Membersihkan float -->
