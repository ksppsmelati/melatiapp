    ...
    <div class="row">
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <br>
          <legend class="text-bold"><i class="fa fa-check"></i> Approval Laporan Kerja</legend>

          <!-- Form untuk melaporkan pekerjaan -->
          <form action="<?php echo site_url('users/update_laporan_kerja_approval/' . $laporan_kerja['id']); ?>" method="post">
...
<div class="col-xs-12 col-sm-6">
            ...
            <div class="form-group">
              ...
              <select class="form-control col-xs-5" name="approval" id="approval" required style="width: 40%;">
                <option value="1" class="option-approve" <?php echo $laporan_kerja['approval'] == 1 ? 'selected' : ''; ?>>
                  &#10003; Approve <!-- Check mark -->
                </option>
                <option value="0" class="option-pending" <?php echo $laporan_kerja['approval'] == 0 ? 'selected' : ''; ?>>
                  &#x23F3; Pending <!-- Clock icon -->
                </option>
              </select>
            </div>
